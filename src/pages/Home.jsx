      ...
      <div className='flex flex-col gap-6 w-3/4'>
        ...
        <div className='bg-[#EAEBF2] rounded-xl'>
          <div className='px-6 py-5 flex justify-between items-center'>
            ...
            <div><GaugeChart value={500} min={400} max={850} label="جيد" status="حساب متفاعل" title="منصة x" description="منشور افتتاح الحدائق" /></div>
            <div><GaugeChart value={680} min={400} max={850} label="جيد" status="حساب متفاعل" title="منصة LinkedIn" description="منشور افتتاح الحدائق" /></div>
          </div>
        </div>
        <div>
